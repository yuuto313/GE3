...
void SrvManager::PreDraw()
{
	...
	pDxCommon_->GetCommandList()->SetDescriptorHeaps(_countof(descriptorHeaps), descriptorHeaps);
...
void SrvManager::CreateSRVforParticle(uint32_t srvIndex, ID3D12Resource* pResource, UINT structureByteStride)
{
	...
	srvDesc.Buffer.NumElements = ParticleManager::ParticleGroup::GetNumInstance();
